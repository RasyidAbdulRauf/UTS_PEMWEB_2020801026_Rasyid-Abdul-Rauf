...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Datepicker CSS -->
		<link rel="stylesheet" href="frontend/css/datepicker.css">
		<!-- Animate CSS -->
    ...
    <body>
		...
		<section class="slider">
			<div class="hero-slider">
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('frontend/img/slider2.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
		...
		<!-- Counter Up CDN JS -->
		<script src="frontend/http://cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.3/waypoints.min.js"></script>
		<!-- Bootstrap JS -->
