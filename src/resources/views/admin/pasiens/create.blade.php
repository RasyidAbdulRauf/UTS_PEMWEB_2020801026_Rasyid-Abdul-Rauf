...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pasien.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pasiens.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('umur') ? 'is-invalid' : '' }}" type="number" name="umur" id="umur" value="{{ old('umur', '') }}" step="0.01">
                @if($errors->has('umur'))
                    <div class="invalid-feedback">
                        {{ $errors->first('umur') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('penyakit') ? 'is-invalid' : '' }}" type="text" name="penyakit" id="penyakit" value="{{ old('penyakit', '') }}" step="1">
